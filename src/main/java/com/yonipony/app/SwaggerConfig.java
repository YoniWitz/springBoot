...
public class SwaggerConfig {
	...
	Contact contact = new Contact("yonipony", "http://www.yonipony.com", "jonhirsh39@gmail.com");
	...
	public Docket apiDocket() {
		Docket docket = new Docket(DocumentationType.SWAGGER_2)
				...
				.apiInfo(apiInfo).select().apis(RequestHandlerSelectors.basePackage("com.yonipony.app"))
